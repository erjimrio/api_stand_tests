...
# El parámetro "firstName" contiene 16 caracter
...
# El parámetro "firstName" contiene palabras con caracteres especiales

def  test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")

# Prueba 7. Creación de un nuevo usuario o usuaria
# El parámetro "firstName" contiene palabras con numeros
